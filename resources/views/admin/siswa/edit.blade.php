                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.siswa.update', $siswa->id) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $siswa->name }}" autocomplete="name" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <input id="nis" type="text" class="form-control @error('nis') is-invalid @enderror" name="nis" value="{{ $siswa->nis }}" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" maxlength="8">
                                @error('nis')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <input id="tgl_lahir" type="date" class="form-control @error('tgl_lahir') is-invalid @enderror" name="tgl_lahir" value="{{ $siswa->tgl_lahir }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <input id="temp_lahir" type="text" class="form-control @error('temp_lahir') is-invalid @enderror" name="temp_lahir" value="{{ $siswa->temp_lahir }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <select name="jurusan_id" id="jurusan_id" class="form-control @error('jurusan_id') is-invalid @enderror">
                                    ...
                                    @foreach($jurusan as $j)
                                        <option value="{{ $j->id }}" {{$siswa->jurusan_id==$j->id ? 'selected' : ''}}>{{ $j->name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-4">
                                <input id="asal_sekolah" type="text" class="form-control @error('asal_sekolah') is-invalid @enderror" name="asal_sekolah" value="{{ $siswa->asal_sekolah }}">
